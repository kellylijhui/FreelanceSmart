...
- [AI Rate Advisor](#ai-rate-advisor)
...
- Formatting invoices that look professional
- Finding contract templates and adapting them to your needs
...
- Invoice date and due date (Net 30 payment terms)
- Itemized services breakdown
- All add-ons and discounts clearly listed
...
To use the AI Rate Advisor, you'll need an OpenAI API key:
...
4. Click "Analyze & Get Rate"
5. Wait 5-10 seconds for AI analysis
6. Review the suggested rate and reasoning
...
The AI considers:
- **Beginner** (CAD $25-50/hr) - Learning, building portfolio
- **Intermediate** (CAD $50-100/hr) - Solid skills, some experience
- **Advanced** (CAD $100-175/hr) - High quality, professional level
- **Expert** (CAD $175-250/hr) - Master level, exceptional quality
...
**Important:** While this template is professionally crafted, always consult with a legal professional for important contracts, especially for large projects or when working internationally.
...
|----------|----------|-------------|
| `OPENAI_API_KEY` | No | Your OpenAI API key for AI Rate Advisor |
...
- All freelancers who provided feedback
